  ...
  const highlights = [
    {
      ...
      hoverGradient:
        "hover:from-purple-700/60 hover:via-indigo-700/60 hover:to-purple-700/60",
    ...
    },
    {
      ...
      description:
        "Develop skills through magical challenges and mystical activities.",
      gradient: "from-indigo-800/50 via-purple-800/50 to-indigo-800/50",
      hoverGradient:
        "hover:from-indigo-700/60 hover:via-purple-700/60 hover:to-indigo-700/60",
    ...
    },
    {
      ...
      hoverGradient:
        "hover:from-amber-700/60 hover:via-yellow-700/60 hover:to-amber-700/60",
    ...
    },
    {
      ...
      description:
        "Built around future skills, digital literacy, and dynamic development.",
      gradient: "from-emerald-800/50 via-teal-800/50 to-emerald-800/50",
      hoverGradient:
        "hover:from-emerald-700/60 hover:via-teal-700/60 hover:to-emerald-700/60",
    ...
    <section className="py-16 sm:py-20 bg-gradient-to-br from-slate-800 via-purple-900 to-slate-800 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          <p className="text-white/90 text-lg sm:text-xl font-medium max-w-3xl mx-auto leading-[1.75] overflow-visible">
          ...
          {highlights.map((highlight, index) => (
            <AnimatedSection key={index} direction="left" delay={index * 200}>
              ...
              >
                ...
                >
                  <highlight.icon
                    className={`w-8 h-8 sm:w-10 sm:h-10 ${highlight.iconColor}`}
                  />
                </div>
