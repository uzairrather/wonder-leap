...
export const AboutSection: React.FC = () => {
  return (
    <section
      id="about"
      className="py-16 sm:py-20 lg:py-28 bg-gradient-to-br from-slate-900 via-gray-900 to-slate-900 relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <AnimatedSection direction="up" className="text-center mb-12 sm:mb-16">
          ...
          {/* Description */}
          <p className="text-base sm:text-xl md:text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed font-medium">
            WonderLeap is a majestic learning kingdom where young explorers discover their destined careers through
            enchanted adventures and epic quests.
          </p>
        </AnimatedSection>
      </div>
    </section>
