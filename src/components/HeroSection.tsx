  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-purple-900 via-indigo-900 to-purple-900 pt-24 min-h-screen flex items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="mb-8">
                ...
                <p className="text-base sm:text-xl lg:text-2xl text-white/95 leading-relaxed drop-shadow-md font-medium">
                  Enter a majestic realm where career discovery becomes an epic
                  adventure for young minds!
                </p>
              </div>

              {/* Launch Countdown */}
              <div className="bg-gradient-to-r from-purple-800/50 via-indigo-800/50 to-purple-800/50 backdrop-blur-2xl rounded-3xl p-6 sm:p-6 mb-8 border-2 border-yellow-400/30 shadow-2xl transform hover:scale-105 transition-all duration-300 relative">
                ...
                <div className="flex items-center justify-center space-x-2 sm:space-x-4 mb-4 sm:mb-6 relative z-10">
                  ...
                  <span className="text-white font-black text-lg sm:text-2xl tracking-wide">
                    WonderLeap Launch Soon!
                  </span>
                  <Diamond className="w-6 sm:w-8 h-6 sm:h-8 text-purple-300 animate-bounce delay-300" />
                </div>
                <p className="text-white/90 text-center text-sm sm:text-lg font-bold relative z-10 whitespace-normal break-words leading-snug">
      ...
      <div className="absolute bottom-0 left-0 right-0 z-0">
        <svg
          className="w-full h-24 sm:h-32 fill-current text-slate-900"
